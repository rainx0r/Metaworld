...
ENV_ASSET_DIR_V2_ORIGINAL = _CURRENT_FILE_DIR / "assets_v2_original"
...
def full_v2_original_path_for(file_name: str) -> str:
    return str(ENV_ASSET_DIR_V2_ORIGINAL / file_name)
